...
Class Client_Session{
    ...
    //public function to get session detail
    public function getsessiondetail(){
        $var = [];
        $var['id'] = self::get_session_id();
        $var['sessions'] = self::all_session_var();
        return $var;
    }

    // Public function get all session vars
    public function all_session_var(){
        return $_SESSION;
    }
